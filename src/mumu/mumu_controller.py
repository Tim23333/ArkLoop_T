...
def pause() -> None:
    ...
    """
    win32api.SendMessage(get_handle(), config.WM_XBUTTONDOWN, config.XBUTTON2, config.DEFAULT_COORDINATES)
    win32api.SendMessage(get_handle(), config.WM_XBUTTONUP, config.XBUTTON2, config.DEFAULT_COORDINATES)
