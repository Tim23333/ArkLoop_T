...
class PerformActionConfig:
    ...
    PRECISE_PAUSE_FRAMES = 5
    ADAPTIVE_PRECISE_PAUSE_MAX_FRAMES = 5
    PAUSE_TOGGLE_MIN_INTERVAL = 0.016
    FRAME_STEP_PULSE_INITIAL = 0.008
    FRAME_STEP_PULSE_MIN = 0.006
    FRAME_STEP_PULSE_MAX = 0.024
    FRAME_STEP_MAX_EMPTY_PULSES = 16
    FRAME_STEP_UPDATE_TIMEOUT = 0.25
    FRAME_STEP_POLL_INTERVAL = 0.004
    FRAME_STEP_FEED_SETTLE = 0.024
    PAUSE_TOGGLE_SETTLE = 0.05
    PAUSE_VERIFY_RETRIES = 3
    PAUSE_VERIFY_READS = 8
    PAUSE_VERIFY_STABLE_READS = 2
    PAUSE_VERIFY_READ_INTERVAL = 0.03
    ACTION_PAUSE_VERIFY_READS = 6
    ACTION_PAUSE_GUARD_INTERVAL = 0.06
    ACTION_RESUME_DELAY = 0.08
    RESUME_TOGGLE_SETTLE = 0.12
    RESUME_VERIFY_RETRIES = 3
